...
#unconvolved
for noise in [2, 5, 10, 25, 50, 60, 80, 100]:
    print("testing UC PSF at noise {}, ".format(noise))
    test_system(noise, 'uc', 'simple', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf, 'poisson')
for noise in [2, 5, 10, 25, 50, 60, 80, 100]:
    print("testing UC PSF at noise {}, ".format(noise))
    test_system(noise, 'uc', 'cnn', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf, 'poisson')
for noise in [0, 25, 50, 75, 100, 125, 150, 200]:
    print("testing UC PSF at noise {}, ".format(noise))
    test_system(noise, 'uc', 'simple', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf, 'gaussian')
for noise in [0, 25, 50, 75, 100, 125, 150, 200]:
    print("testing UC PSF at noise {}, ".format(noise))
    test_system(noise, 'uc', 'cnn', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf, 'gaussian')
#diffuser
for noise in [2, 5, 10, 25, 50, 60, 80, 100]:
    print("testing Diffuser PSF at noise {}, ".format(noise))
    test_system(noise, 'diffuser', 'simple', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf, 'poisson')
for noise in [2, 5, 10, 25, 50, 60, 80, 100]:
    print("testing Diffuser PSF at noise {}, ".format(noise))
    test_system(noise, 'diffuser', 'cnn', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf, 'poisson')
for noise in [0, 25, 50, 75, 100, 125, 150, 200]:
    print("testing Diffuser PSF at noise {}, ".format(noise))
    test_system(noise, 'diffuser', 'simple', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf, 'gaussian')
for noise in [0, 25, 50, 75, 100, 125, 150, 200]:
    print("testing Diffuser PSF at noise {}, ".format(noise))
    test_system(noise, 'diffuser', 'cnn', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf, 'gaussian')
#phlat 
for noise in [2, 5, 10, 25, 50, 60, 80, 100]:
    print("testing Phlat PSF at noise {}, ".format(noise))
    test_system(noise, 'phlat', 'simple', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf, 'poisson')
for noise in [2, 5, 10, 25, 50, 60, 80, 100]:
    print("testing Phlat PSF at noise {}, ".format(noise))
    test_system(noise, 'phlat', 'cnn', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf, 'poisson')
for noise in [0, 25, 50, 75, 100, 125, 150, 200]:
    print("testing Phlat PSF at noise {}, ".format(noise))
    test_system(noise, 'phlat', 'simple', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf, 'gaussian')
for noise in [0, 25, 50, 75, 100, 125, 150, 200]:
    print("testing Phlat PSF at noise {}, ".format(noise))
    test_system(noise, 'phlat', 'cnn', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf, 'gaussian')
