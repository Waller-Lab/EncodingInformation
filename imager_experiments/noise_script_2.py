...
#    print("testing psf_4 at noise {}".format(noise))
#    test_system(noise, 'psf_4', 'cnn', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf)
...
#    test_system(noise, 'uc', 'cnn', seed_values, data, labels, training_fraction, testing_fraction, diffuser_region, phlat_region, psf)
